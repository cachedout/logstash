...
* Fix line codec tests https://github.com/elastic/logstash/pull/10446[#10446]
...
603fe5cf5 - (HEAD -> 6.6, origin/6.6) update dependency notices for 6.6.1 release (#10444) (2 minutes ago) <Ry Biesemeyer>
69e57b63d - Incorporate review comments (61 minutes ago) <Karen Metts>
f601e392f - Add prilileges required for ilm (61 minutes ago) <Karen Metts>
3b5855c85 - Move field-ref include below xpack content (21 hours ago) <Karen Metts>
a9af53240 - Edits from review comments (2 days ago) <Karen Metts>
71537d6dc - Expande descriptions (2 days ago) <Karen Metts>
c28385833 - Add http and memcached filters to lookup plugins (2 days ago) <Karen Metts>
aa1a3932f - Reorder files in index to unhide lost topics Add comment about placement of include (2 days ago) <Karen Metts>
bc6080100 - Update patch plugin versions in gemfile lock (#10426) (2 days ago) <João Duarte>
794e391d9 - Remove unnecessary option to not require host in SafeURI (6 days ago) <Rob Bavey>
d11aa5a87 - Better handle malformed URIs (6 days ago) <Rob Bavey>
68144e09b - mute metrics_spec line 138 test (7 days ago) <Joao Duarte>
6548501c2 - keystore: instances of `CharsetEncoder` are stateful and cannot be shared (8 days ago) <Ry Biesemeyer>
3bdc57ac3 - spec: make timing-sensitive specs a little more flexible (8 days ago) <Ry Biesemeyer>
bd6a26615 - spec: noop refactor for clarity - use explicit `metric_input` subject instead of implicit subject - use rspec/wait full expectation syntax instead of be_falsey/be_truthy - eliminate unused shared examples - incorporate single-use shared examples (8 days ago) <Ry Biesemeyer>
5b7f60e9b - agent webserver: synchronise control (8 days ago) <Ry Biesemeyer>
1ab316ebe - change 「5.x」→「6.x」 (9 days ago) <taku333>
7cb8d471a - Update patch plugin versions in gemfile lock (#10363) (9 days ago) <Guy Boertje>
ef0d135d9 - qa: allow connections to localhost in webmock (#10384) (9 days ago) <Ry Biesemeyer>
8bef18ada - fix agent silent exit upon pipelines reloading (#10370) (2 weeks ago) <Colin Surprenant>
f2a473db8 - correctly handle pipeline actions (#10331) (#10337) (2 weeks ago) <Colin Surprenant>
